...
namespace Library.API.Controllers
{
  ...
  public class AuthorsController : Controller
  {
    ...
    /// </summary>
    /// <param name="authorsResourceParameters">Order, Filter and search clause</param>
        ...
        [FromHeader(Name = "Accept")] string mediaType)
    {
      ...
      if (mediaType == "application/vnd.marvin.hateoas+json")
      {
        ...
        //Adds pagination response in the header
        ...
        //return status code OK for get request
    ...
    /// <summary>
    /// Gets specific Author by id.
    /// </summary>
    /// <param name="id"></param>
    /// <param name="fields">Fields list to get from author object
    /// </param>
    /// <returns></returns>
    [Route("api/authors/{id}", Name = "GetAuthor")]
    [HttpGet]
    ...
    [HttpPut]
    public IActionResult UpdateAuthor(Guid id,
    ...
    public IActionResult DeleteAuthor(Guid id)
    {
      ...
      //*EFcore, deletes the object by taking object as parameter, in future version it may use ID for delete
    ...
    /*
          [Route("api/authors/CreateAuthorWithDateOfDeath")]
          [HttpPost]
